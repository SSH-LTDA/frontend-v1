			...
			<div className="flex flex-wrap -mx-4 pt-10">
				<div className="w-full md:w-1/2 px-4 mb-8">
					...
					<p className="text-lg mb-4">
						Na Pousada Quinta do Ypuã levamos nossos clientes a sério. Se você tem alguma dúvida, reclamação ou
						solicitação, encaminhe-o para nossa equipe e entraremos em contato com você o mais breve possível.
					</p>
					<h3 className="text-base mb-2">
						Estrada Ipua, nº 6<br />
						Laguna - SC
					</h3>
					...
					<p className="text-lg mb-4 font-bold text-[#886023]">Ou se preferir, envie-nos uma mensagem via WhatsApp</p>
					<a
