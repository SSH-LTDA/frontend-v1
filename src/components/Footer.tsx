			...
			<div className="bg-[#886023] w-[full] flex justify-evenly py-14 text-white max-[850px]:flex-col max-[850px]:items-center max-[850px]:gap-8 max-[850px]:text-center">
				...
				<div>
					<ul className="h-full flex flex-col justify-between font-semibold">
						<li className="cursor-pointer" onClick={() => window.location.assign("/contact-us")}>
							Contato
						</li>
				...
				<div>
					<ul className="h-full flex flex-col justify-between font-semibold w-full">
						<li
							...
							onClick={() => window.open("https://www.instagram.com/pousadaquintadoypua/")}
						>
							<RiInstagramFill size={20} /> Instagram
						</li>
						<li
							className="flex items-center gap-2 cursor-pointer"
							onClick={() => window.open("https://www.google.com.br/travel/hotels/entity/CgoIh9jHt_yj0pIqEAE")}
						>
							<RiGoogleFill size={20} /> Google
						</li>
						<li
							className="flex items-center gap-2 cursor-pointer"
							onClick={() => window.open("https://www.facebook.com/pousadaquintadoypua/")}
						>
